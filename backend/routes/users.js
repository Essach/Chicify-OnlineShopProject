...
const { postUserCreate, postUserLogin, patchUserOrder, patchUserFavorite, patchUserSeller, patchUserPassword, getUserName, getUsers, patchSendMessage, patchUserSellProduct } = require('../controllers/users.js');
...
router.patch('/product', patchUserSellProduct);
